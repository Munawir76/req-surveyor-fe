...
function Footer() {
  ...
  return (
    <div class="bg-white dark:bg-gray-900">
      <div class="mx-auto w-full max-w-screen-xl lg:w-full">
        ...
        <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-center sm:flex sm:justify-center lg:flex lg:justify-center">
